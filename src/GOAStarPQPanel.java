...
public class GOAStarPQPanel extends JPanel  {
	...
	public GOAStarPQPanel(int applesEaten, int width, int height, Graphics g, JFrame frame) {
		...
		againB.addActionListener(new PAAStarPQListener(frame));
		add(againB);
	}
